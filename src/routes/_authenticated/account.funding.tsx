  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-border bg-surface/40 p-3 text-xs space-y-1">
        ...
        <div className="font-mono text-muted-foreground">SpaceX IPO Exchange LLC · Citibank N.A.</div>
        <div className="font-mono text-muted-foreground">Account: 4738-2901-887 · SWIFT: CITIUS33</div>
