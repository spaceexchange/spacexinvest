  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-border bg-surface/40 p-3 text-xs space-y-1">
        ...
        <div className="font-mono text-muted-foreground">Routing Number(WIRE): 121000248</div>
        <div className="font-mono text-muted-foreground">OR</div>
        <div className="font-mono text-muted-foreground">Routing Number (ACH):125008547</div>
